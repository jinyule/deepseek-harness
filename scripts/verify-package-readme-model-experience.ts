...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/llm/llm-pi-ai-oauth': { kind: 'none', reason: 'The credential service changes only provider authentication metadata and adds no model-visible request content.' },
