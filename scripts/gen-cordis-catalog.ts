...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PiAiOAuthAnswerRequest: 'llm-streaming.md',
  PiAiOAuthCommandResult: 'llm-streaming.md',
  PiAiOAuthDescribeValue: 'llm-streaming.md',
  PiAiOAuthLoginEvent: 'llm-streaming.md',
  PiAiOAuthProviderRequest: 'llm-streaming.md',
  PiAiOAuthStartRequest: 'llm-streaming.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  PiAiCredential: 'pi-ai credential fields are owned by @earendil-works/pi-ai',
  PiAiCredentialInfo: 'pi-ai credential metadata is owned by @earendil-works/pi-ai',
