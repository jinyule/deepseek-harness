...
export const en = {
  ...
  oauthConnected: 'Subscription account connected',
  oauthRequired: 'Connect a subscription account to use this provider.',
  oauthSignIn: 'Sign in',
  ...
  oauthOpenBrowser: 'Open sign-in page',
  oauthBrowserReady: 'Complete sign-in in the browser, then return here.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  oauthConnected: '订阅账号已连接',
  oauthRequired: '请连接订阅账号后使用此提供方。',
  oauthSignIn: '登录',
  oauthSignOut: '退出登录',
  oauthStarting: '正在开始登录…',
  oauthCancel: '取消登录',
  oauthCancelled: '已取消登录。',
  oauthContinue: '继续',
  oauthOpenBrowser: '打开登录页面',
  oauthBrowserReady: '请在浏览器中完成登录，然后返回此处。',
  oauthOpenVerification: '打开验证页面',
  oauthDeviceCode: '设备代码',
