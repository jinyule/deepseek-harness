...
import piAiOAuthRemote from '@deepseek-ai/dsh-llm-pi-ai-oauth/remote'
...
export type {} from '@deepseek-ai/dsh-llm-pi-ai-oauth/remote'
...
export type {} from '@deepseek-ai/dsh-llm-pi-ai-oauth/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      commandsRemote, goalsRemote, dynamicRemote, pluginInventoryRemote, messageFeedbackRemote, piAiOAuthRemote,
    ]) {
